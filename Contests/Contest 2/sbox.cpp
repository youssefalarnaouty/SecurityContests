...
int permutation(int out_size, int table[], int in_size, int input) {
	string value;
	string output1 = "";
...
void sbox(int s1[4][16], int s2[4][16], int s3[4][16], int s4[4][16], int s5[4][16], int s6[4][16], int s7[4][16], int s8[4][16], long long keyword) {
	string output = "";
	int row;
	//S1
	...
	row = stoi(temp2, 0, 2);
	output += to_string(s2[row][middle]);
	cout << hex << uppercase << s2[row][middle];
	//S3
	...
	row = stoi(temp3, 0, 2);
	output += to_string(s3[row][middle]);
	cout << hex << uppercase << s3[row][middle];
	//S4
	...
	row = stoi(temp4, 0, 2);
	output += to_string(s4[row][middle]);
	cout << hex << uppercase << s4[row][middle];
	//S5
	...
	row = stoi(temp5, 0, 2);
	output += to_string(s5[row][middle]);
	cout << hex << uppercase << s5[row][middle];
	//S6
	...
	row = stoi(temp6, 0, 2);
	output += to_string(s6[row][middle]);
	cout << hex << uppercase << s6[row][middle];
	//S7
	...
	row = stoi(temp7, 0, 2);
	output += to_string(s7[row][middle]);
	cout << hex << uppercase << s7[row][middle];
	//S8
	...
	row = stoi(temp8, 0, 2);
	output += to_string(s8[row][middle]);
	cout << hex << uppercase << s8[row][middle];
...
int main() {
	...
	int s8[4][16] = { {4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 },
	...
	sbox(s1, s2, s3, s4, s5, s6, s7, s8, value);
