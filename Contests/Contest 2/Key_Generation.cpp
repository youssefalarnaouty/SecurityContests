...
unsigned long long int key_generated(int PC1[], int PC2[], int Rotations[], unsigned long long int key) {
	...
	for (int i = 0; i < 16; i++)
	{
		...
		cout << hex << uppercase << setfill('0') << setw(12) << key48 << endl;
	}
	return key48;
}
...
{2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11} };
	...
	*/
	...
	unsigned long long int key = key_generated(PC1, PC2, Rotations, givenkey);
